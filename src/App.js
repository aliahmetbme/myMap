...
const App = () => {
  ...
  const coordinates = [
    ...
    { latitude: 37.78915, longitude: -122.4345 },
    { latitude: 37.78945, longitude: -122.4365 },
  ];
  ...
  return (
    ...
    > */}
      {/* <Polyline coordinates={coordinates} strokeColor="#F00" strokeWidth={2} /> * bir patşka belirtiyor */}
      <Polygon coordinates={coordinates} fillColor="rgba(255, 0, 0, 0.5)" /> 
      {/** bir taralı alan  */}
    {/* </MapView> */}
    <MapView
      style={{ flex: 1 }}
    ...
    <MapView
      ...
      showsUserLocation={true} // Kullanıcının konumunu harita üzerinde göster
    >
      {currentLocation && (
        <Marker
          coordinate={{
